    ...
    render(){
        return(
                <div className="header__nav__navigator__list">
                  <div className="header__nav__navigator__list__div ch_con ch_con--1" onClick={ ()=>this.props.onRouteChange('home')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--2" onClick={ ()=>this.props.onRouteChange('about')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--3" onClick={ ()=>this.props.onRouteChange('reiki')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--4" onClick={ ()=>this.props.onRouteChange('terapy')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--5" onClick={ ()=>this.props.onRouteChange('contact')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--6" onClick={ ()=>this.props.onRouteChange('location')}>
                    ...
                    <div className="header__nav__navigator__list__div ch_con ch_con--7" onClick={ ()=>this.props.onRouteChange('chakras')}>
